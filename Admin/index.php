...
$sql="SELECT * FROM `general_setting` WHERE  `user_name`='$au' and `password`='$ad'  and id IN(1) ";
...
<div id="login-holder">
	...
	<form action="index.php" method="post" >
 	...
 	<!--  end login-inner -->
	<div class="clear"></div>
	<a href="" class="forgot-pwd">Forgot Password?</a><a href="hoteladminlog.php" class="another-user">Hotel Admin</a>
 </div>
 <!--  end loginbox -->
