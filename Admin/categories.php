...
if(isset($_POST['submit'])){
	...
	$sql1="INSERT INTO `category_hotel`( `parent_id`, `name`, `meta_title`, `meta_keyword`, `pagetitle`, `imageurl`)
	VALUES (0,'$categoryname','$meta','$meta','$meta','$image')";
...
if($delid!="")
{
$del="DELETE FROM `category_hotel` WHERE `id` =$delid";
mysql_query($del);
...
<div class="nav-outer"> 
		...
		<div class="select_sub">
			<ul class="sub">
				...
				<li><a href="subcat.php">Add Sub Categories</a></li>
			</ul>
		</div>
		<!--[if lte IE 6]></td></tr></table></a><![endif]-->
		</li>
...
<tr>
	...
	<td>
		...
		<div id="step-holder">
			...
			<div class="step-light-left"><a href="subcat.php">Add Sub Categories</a></div>
		...
		<tr>
			...
			<td><input type="text" name="cname" id="cname" class="inp-form-error" /></td>
			<td>
